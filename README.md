...
Non-DKMS kmod package can be generated by adding `-m` option to `build-rpm-packages.sh`.
Unlike DKMS kmod, this package is specific to the NVIDIA driver version and the
Linux kernel version used to build the package.
